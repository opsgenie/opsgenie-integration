...
def getAlertHistogram(entity) {
    String url = getUrl("alert_histogram_image_url", "/nagiosxi/includes/components/nagioscore/ui/histogram.php", false)
    return getImage(url, entity);
}

def getTrends(entity) {
    String url = getUrl("trends_image_url", "/nagiosxi/includes/components/nagioscore/ui/trends.php", false)
    return getImage(url, entity);
}
